...
interface ForecastBgProps {
  className?: string;
}

const ForecastBg: React.FC<ForecastBgProps> = ({ className }) => {
  return (
    <svg className={className} viewBox='0 0 750 400' preserveAspectRatio='xMinYMin slice'>
