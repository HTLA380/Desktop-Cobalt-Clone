...
const DashBoard = () => {
  ...
  window.addEventListener("scroll", () => {
    ...
    if (
      dashboardRef.current.offsetHeight - window.scrollY >
      dashboardRef.current.offsetHeight - 80
    )
  ...
  return (
    <div className="relative">
      ...
      {/* dashboard image */}
      <div
        className="rounded-md bg-zinc-950 ring-1 ring-white/10 lg:rounded-2xl transition duration-700 relative"
        ...
        <div className="absolute -top-px right-20 h-2 w-20 [mask-image:linear-gradient(to_right,rgba(217,217,217,0)_0%,#d9d9d9_25%,#d9d9d9_75%,rgba(217,217,217,0)_100%)] md:w-32 lg:w-64 z-10">
          <div className="h-px w-full dashboard-border-animation-1 bg-gradient-to-r from-cyan-400/0 via-cyan-400 to-cyan-400/0"></div>
        </div>
        ...
        <div className="absolute -bottom-2 left-20 h-2 w-20 [mask-image:linear-gradient(to_right,rgba(217,217,217,0)_0%,#d9d9d9_25%,#d9d9d9_75%,rgba(217,217,217,0)_100%)] md:w-32 lg:w-64">
          <div className="h-px w-full dashboard-border-animation-2 bg-gradient-to-r from-cyan-400/0 via-cyan-400 to-cyan-400/0"></div>
        </div>
      </div>
    </div>
  );
